                        ...
                        {mode === 'auto' && (
                            <div className="mt-3 text-center">
                                <p className="text-xs text-gray-500 font-medium">
                                    💡 <strong className="text-gray-700">Chế độ Tự Động:</strong> Chỉ cần hướng mặt vào camera, hệ thống sẽ tự động nhận diện và cập nhật {attendanceType === 'check_in' ? 'giờ vào (check-in)' : 'giờ ra (check-out)'}.
                                </p>
                            </div>
                        )}
                    </div>
