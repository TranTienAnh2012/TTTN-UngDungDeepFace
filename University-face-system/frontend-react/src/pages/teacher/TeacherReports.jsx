    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto pb-12 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                    onClick={() => alert("Đang tải xuống báo cáo điểm danh Excel (.xlsx)...")}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {mockReportSummary.map((item, idx) => (
                    ...
                    <table className="w-full text-left text-xs">
                        ...
                        <tbody className="divide-y divide-slate-100 font-medium">
                            <tr className="hover:bg-slate-50 transition-colors">
                                <td className="py-3.5 px-4 font-bold text-slate-900">CS101 - Nhập môn Khoa học máy tính</td>
                                <td className="py-3.5 px-4 font-mono">45 SV</td>
                                <td className="py-3.5 px-4 font-mono">12 buổi</td>
                                <td className="py-3.5 px-4 font-bold text-emerald-600">95.8%</td>
                                <td className="py-3.5 px-4 font-mono text-slate-600">1.8 SV/buổi</td>
                                <td className="py-3.5 px-4 text-right">
                                    <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-bold">Rất tốt</span>
                                </td>
                            </tr>
                            <tr className="hover:bg-slate-50 transition-colors">
                                <td className="py-3.5 px-4 font-bold text-slate-900">CS204 - Cấu trúc dữ liệu & Giải thuật</td>
                                <td className="py-3.5 px-4 font-mono">40 SV</td>
                                <td className="py-3.5 px-4 font-mono">10 buổi</td>
                                <td className="py-3.5 px-4 font-bold text-emerald-600">93.2%</td>
                                <td className="py-3.5 px-4 font-mono text-slate-600">2.7 SV/buổi</td>
                                <td className="py-3.5 px-4 text-right">
                                    <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-bold">Tốt</span>
                                </td>
                            </tr>
                            <tr className="hover:bg-slate-50 transition-colors">
                                <td className="py-3.5 px-4 font-bold text-slate-900">SE220 - Phát triển ứng dụng Web</td>
                                <td className="py-3.5 px-4 font-mono">43 SV</td>
                                <td className="py-3.5 px-4 font-mono">8 buổi</td>
                                <td className="py-3.5 px-4 font-bold text-indigo-600">92.0%</td>
                                <td className="py-3.5 px-4 font-mono text-slate-600">3.4 SV/buổi</td>
                                <td className="py-3.5 px-4 text-right">
                                    <span className="px-2.5 py-0.5 rounded-full bg-indigo-100 text-indigo-700 text-[10px] font-bold">Đạt yêu cầu</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
