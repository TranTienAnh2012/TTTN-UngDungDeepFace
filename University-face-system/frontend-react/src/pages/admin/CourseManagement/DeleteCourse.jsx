...
const DeleteCourse = ({ isOpen, onClose, onCourseDeleted, course }) => {
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-5">
                    ...
                    <p className="text-gray-600">
                        Bạn có chắc chắn muốn xóa môn học <span className="font-bold text-gray-900">{course.course_code} - {course.course_name}</span>?
                    </p>
                    <p className="text-sm text-red-500 mt-2 font-medium">
                        Hành động này không thể hoàn tác và chỉ thực hiện được nếu môn học chưa có lịch học/thi.
                    </p>
