...
const DeleteStudent = ({ isOpen, onClose, onStudentDeleted, student }) => {
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-5">
                    ...
                    <p className="text-gray-600">
                        Bạn có chắc chắn muốn xóa sinh viên <span className="font-bold text-gray-900">{student.student_code} - {student.full_name}</span>?
                    </p>
                    <p className="text-sm text-red-500 mt-2 font-medium">
                        Dữ liệu khuôn mặt và thông tin liên quan sẽ bị xóa. Hành động này không thể hoàn tác.
                    </p>
