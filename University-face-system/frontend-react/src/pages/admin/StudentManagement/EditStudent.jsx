...
import { X, UserCheck, Building, Layers, Mail, Calendar, User, Code } from 'lucide-react';
...
const EditStudent = ({ isOpen, onClose, onStudentUpdated, student }) => {
    ...
    useEffect(() => {
        if (student) {
            ...
            setFormData({
                ...
                class_name: student.class_code || student.class_name || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormError(error.response?.data?.message || 'Có lỗi xảy ra khi cập nhật sinh viên');
        } finally {
